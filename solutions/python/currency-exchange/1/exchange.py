...
def exchange_money(budget, exchange_rate):
    ...
    """
    estimate_value = budget / exchange_rate
...
def get_value_of_bills(denomination, number_of_bills):
    ...
    total_value_of_bill = denomination * number_of_bills
    return total_value_of_bill
...
def get_number_of_bills(amount, denomination):
    ...
    number_currency_bill = amount // denomination
    return number_currency_bill
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    maxvalue_of_newcurrency = (budget / (exchange_rate + (exchange_rate * (spread / 100))) // denomination ) * denomination
    return maxvalue_of_newcurrency
